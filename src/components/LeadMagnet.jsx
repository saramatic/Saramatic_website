...
export default function LeadMagnet() {
    return (
        <>
            {/* SECTION 1 – HERO (Light Pink) */}
            <section className="bg-[#fdeeee] py-20 px-6 text-[#514241]">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    {/* Small divider */}
                    <div className="w-16 h-[2px] bg-[#f2d6d4] mx-auto" />
                </div>
            </section>
                ...
                <div className="max-w-3xl mx-auto text-sm sm:text-base font-sans space-y-10">
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                            {/* Shadow card */}
                            <div className="bg-white border border-[#f2d6d4] rounded-xl p-4 shadow-sm">
            ...
            {/* SECTION 3 – TEAL BAND: CHATGPT + HOW IT WORKS */}
            <section className="bg-[#e7f3f3] py-16 px-6 text-[#514241]">
                <div className="max-w-3xl mx-auto text-sm sm:text-base font-sans space-y-10">
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="bg-white/80 border border-[#cfe3e3] rounded-xl p-4">
                                ...
                                <p className="text-xs mt-2 text-[#6b7a7a]">
